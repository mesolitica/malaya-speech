...
class WhisperModel(WhisperPreTrainedModel):
    ...
    def forward(
        ...
        attention_mask = attention_mask[:,::4].unsqueeze(-1)
        ...
        hidden_states, indices = self.apply_vq(hidden_states, attention_mask[:,:,0])
...
def main():
    ...
    model.model.init_quantize_layer('conv-centroids-v2.npy')
