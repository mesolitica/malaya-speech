        ...
        def __getitem__(self, idx):
            ...
            try:
                ...
                for i, L in enumerate(seq_lens):
                    ...
                    tgt[i, 1 + L, :] = eos_val
                    tgts.append(tgt[i, : L + 2])
                    tgt_lens.append(L + 2)
                    dec_self_attn_mask.append(torch.tril(torch.ones((L + 2, L + 2), dtype=torch.bool)))
                    tgt_pos.append(torch.arange(L + 2))
