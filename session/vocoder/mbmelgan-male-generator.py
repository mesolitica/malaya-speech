...
sub_band_stft_loss = stft.MultiResolutionSTFT(
    **mb_melgan_config.config['subband_stft_loss_params']
)

full_band_stft_loss = stft.MultiResolutionSTFT(
    **mb_melgan_config.config['stft_loss_params']
)
