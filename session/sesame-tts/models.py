...
class Model(
    ...
    def gradient_checkpointing_enable(self, **kwargs):
        ...
        apply_activation_checkpointing(self.backbone, auto_wrap_policy=auto_wrap_policy)
        apply_activation_checkpointing(self.decoder, auto_wrap_policy=auto_wrap_policy)
