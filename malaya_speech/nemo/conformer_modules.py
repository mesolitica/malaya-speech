...
from malaya_speech.nemo.batchnorm import FusedBatchNorm1d
from malaya_speech.nemo.causal_convs import CausalConv1D
from malaya_speech.nemo.multi_head_attention import (
    MultiHeadAttention,
...
class ConformerLayer(torch.nn.Module, AdapterModuleMixin, AccessMixin):
    ...
    def forward(
        ...
        if self.self_attention_model == 'rel_pos':
            ...
            x = self.self_attn(query=x, key=x, value=x, pad_mask=pad_mask,
                               pos_emb=pos_emb, cache=cache_last_channel)
