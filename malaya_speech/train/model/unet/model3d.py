...
class Model:
    def __init__(
        ...
        up1 = conv3d_transpose_factory(conv_n_filters[4], (4, 4, 4))((conv6))
        ...
        up2 = conv3d_transpose_factory(conv_n_filters[3], (4, 4, 4))((merge1))
        ...
        up3 = conv3d_transpose_factory(conv_n_filters[2], (4, 4, 4))((merge2))
        ...
        up4 = conv3d_transpose_factory(conv_n_filters[1], (4, 4, 4))((merge3))
        ...
        up5 = conv3d_transpose_factory(conv_n_filters[0], (4, 4, 4))((merge4))
        ...
        up6 = conv3d_transpose_factory(1, (4, 4, 4), strides = (1, 2, 2))(
            (merge5)
        )
