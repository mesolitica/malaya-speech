...
from malaya_speech.torch_model.vits import commons
from malaya_speech.torch_model.vits import modules
from malaya_speech.torch_model.vits_v2 import attentions

from torch.nn import Conv1d, ConvTranspose1d, AvgPool1d, Conv2d
from torch.nn.utils import weight_norm, remove_weight_norm, spectral_norm
from malaya_speech.torch_model.vits.commons import init_weights, get_padding
...
class Generator(torch.nn.Module):
    def __init__(
        ...
        for i, (u, k) in enumerate(zip(upsample_rates, upsample_kernel_sizes)):
            self.ups.append(weight_norm(ConvTranspose1d(upsample_initial_channel //
                            (2**i), upsample_initial_channel//(2**(i+1)), k, u, padding=(k-u)//2)))
