...
saver.restore(sess, tf.train.latest_checkpoint('hifigan-yasmin'))

saver = tf.train.Saver()

checkpoint = 10000
epoch = 4_000_000
path = 'hifigan-yasmin-combined'
