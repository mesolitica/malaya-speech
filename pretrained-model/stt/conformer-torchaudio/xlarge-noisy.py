...
"""
CUDA_VISIBLE_DEVICES=0 python3 xlarge-noisy.py --batch=12 --precision=32 --accumulate=2
"""
...
if __name__ == '__main__':
    ...
    train_dataset = MalayaDataset(
        '/home/husein/malaya-speech/mixed-stt-train-augmented.json', sp_model)
    ...
    model_directory = f'conformer-xlarge-mixed-{precision}'
