...
"""
CUDA_VISIBLE_DEVICES=1 python3 conformer-base-singlish.py --batch=16 --precision=32
"""
...
if __name__ == '__main__':
    ...
    train_dataset = MalayaDataset('/home/husein/malaya-speech/singlish-stt-train.json', sp_model)
    train_loader = torch.utils.data.DataLoader(train_dataset, batch_size=batch_size, num_workers=7, collate_fn=batch)

    val_dataset = MalayaDataset('/home/husein/malaya-speech/singlish-stt-test.json', sp_model)
    val_loader = torch.utils.data.DataLoader(train_dataset, batch_size=12, collate_fn=batch)

    model_directory = f'conformer-base-singlish-{precision}'
