...
"""
CUDA_VISIBLE_DEVICES=1 python3 conformer-large.py --batch=12 --precision=32
"""
...
if __name__ == '__main__':
    ...
    train_dataset = MalayaDataset('/home/husein/malaya-speech/mixed-stt-train-v2.json', sp_model)
    ...
    model_directory = f'conformer-medium-mixed-{precision}'
