...
This directory to save pretrained checkpoints and steps to reproduce.
...
## Directory
  ...
  * [speaker-embedding](speaker-embedding)
    ...
    * [inception-v4](speaker-embedding/inception-v4)
    * [speakernet](speaker-embedding/speakernet)
    * [vggvox](speaker-embedding/vggvox)
  ...
  * [Vocoder](vocoder)
    ...
    * [MBMelGAN](mbmelgan)
    * [MelGAN](melgan)
    * [Universal MelGAN](universal-melgan)
