...
mel_stat = np.load('/home/ubuntu/speech-bahasa/osman-stats/stats.npy')
...
def noam_schedule(step, channels, learning_rate=1.0, warmup_steps=4000):
    return learning_rate * channels ** -0.5 * tf.minimum(step ** -0.5, step * warmup_steps ** -1.5)
