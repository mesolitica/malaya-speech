...
files = glob('/home/husein/speech-bahasa/output-female-v3/mels/*.npy')
...
def model_fn(features, labels, mode, params):
    ...
    config_glowtts = glowtts.Config_GlowTTS(config_glowtts)
    ...
    l_length = duration_loss(tf.transpose(logw, [0, 2, 1]), logw_, input_lengths)
